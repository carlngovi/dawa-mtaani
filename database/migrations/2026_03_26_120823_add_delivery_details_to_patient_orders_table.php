...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('patient_orders', function (Blueprint $table) {
            $table->string('customer_first_name', 100)->nullable()->after('patient_name');
    ...
    {
        Schema::table('patient_orders', function (Blueprint $table) {
            $table->dropColumn(['customer_first_name', 'customer_last_name', 'customer_email', 'delivery_address', 'delivery_instructions']);
        });
    }
};
