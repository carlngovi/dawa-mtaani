...
<div x-data="{ show: false, items: [] }" x-cloak
    ...
    <div x-show="show" class="fixed inset-0 z-50 flex items-center justify-center">
        ...
        <div class="relative z-10 w-full max-w-lg rounded-xl bg-white p-6 shadow-2xl">
            <h3 class="text-lg font-semibold text-gray-900">Some Items Unavailable</h3>
            <p class="mt-1 text-sm text-gray-500">The following items cannot be fully fulfilled:</p>
                ...
                <template x-for="item in items" :key="item.product_name">
                    <li class="flex items-center justify-between py-3">
                        ...
                        <span class="text-sm text-gray-500">
                            ...
                            &middot; Available: <span class="font-semibold text-red-600" x-text="item.available_qty"></span>
                        </span>
                    </li>
                </template>
            </ul>
            ...
            <div class="mt-6 flex justify-end gap-3">
                ...
                <button @click="show = false; $dispatch('proceed-partial')" class="rounded-lg bg-indigo-600 px-4 py-2 text-sm font-medium text-white hover:bg-indigo-700">
                    Proceed Anyway
                </button>
            </div>
        </div>
