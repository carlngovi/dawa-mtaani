...
@section('title', 'Leaderboard — Sales Rep')
@section('content')
<div class="space-y-6">
    ...
    <div class="flex gap-2">
        ...
        <a href="{{ route('sales.leaderboard.index', ['period' => $key]) }}" class="px-4 py-2 rounded-full text-sm font-medium {{ $period === $key ? 'bg-yellow-400 text-gray-900' : 'bg-gray-800 border border-gray-700 text-gray-400' }}">{{ $label }}</a>
        @endforeach
    </div>
