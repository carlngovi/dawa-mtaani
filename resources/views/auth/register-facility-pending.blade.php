...
<div class="min-h-screen flex flex-col items-center justify-center px-4">
    ...
    <div class="w-full max-w-md text-center">
        ...
        <p class="text-gray-600 dark:text-gray-400 mb-8">
            Your application for <strong class="text-gray-900 dark:text-white">{{ $facilityName }}</strong> has been submitted.
        ...
        <a href="{{ route('login') }}"
           class="inline-flex items-center justify-center rounded-lg bg-yellow-400 px-6 py-3 text-sm font-bold text-gray-900 hover:bg-yellow-300 transition-colors">
            Back to Sign In
        </a>
    </div>
</div>
