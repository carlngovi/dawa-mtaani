    ...
    <div class="bg-gray-800 rounded-xl border border-gray-700 p-5">
        ...
        <form method="POST" action="/api/v1/network/reports/export"
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-3">
                ...
                <button type="submit" class="px-4 py-2 bg-yellow-400 text-white text-sm rounded-lg hover:bg-yellow-500">
                    Request Export
                </button>
            </div>
        </form>
                ...
                <tr class="hover:bg-gray-900">
                    ...
                    <td class="px-5 py-3">
                        <span class="inline-flex px-2 py-0.5 rounded text-xs font-medium
                            {{ match($export->status) {
                                'READY'      => 'bg-green-900/30 text-green-400 border border-gray-700',
                                'GENERATING' => 'bg-blue-900/30 text-blue-400 border border-gray-700',
