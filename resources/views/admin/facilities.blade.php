    ...
    <form method="GET" class="bg-gray-800 rounded-xl border border-gray-700 p-4">
        <div class="grid grid-cols-2 lg:grid-cols-5 gap-3">
            ...
            <div class="flex gap-2">
                ...
                <button type="submit" class="px-4 py-2 bg-yellow-400 hover:bg-yellow-500 text-white text-sm font-medium rounded-lg transition-colors">
                    Filter
                </button>
            </div>
        </div>
                            ...
                            <td class="px-5 py-3">
                                <span class="inline-flex px-2 py-0.5 rounded text-xs font-medium
                                    {{ match($facility->facility_status) {
                                        ...
                                        'SUSPENDED' => 'bg-red-900/30 text-red-400 border border-gray-700',
