...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-4">
            ...
            <p class="text-2xl font-bold text-amber-600">{{ number_format($summary['low_stock']) }}</p>
        </div>
        <div class="bg-white rounded-xl border border-gray-200 p-4">
    ...
    <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
        <table class="w-full text-sm min-w-[640px]">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-5 py-3 text-gray-500 text-xs">{{ $item->facility_name }}</td>
        ...
        <div class="px-5 py-3 border-t border-gray-100">{{ $inventory->links() }}</div>
    </div>
</div>
@endsection
