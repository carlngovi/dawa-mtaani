        ...
        <div class="overflow-x-auto"><table class="w-full text-sm min-w-[900px]">
            ...
            <tbody class="divide-y divide-gray-700">
                ...
                <tr class="hover:bg-gray-900">
                    ...
                    <td class="px-5 py-3">
                        <span class="inline-flex px-2 py-0.5 rounded text-xs font-medium
                            {{ match($order->status) {
                                ...
                                'DISPUTED'  => 'bg-red-900/30 text-red-400 border border-gray-700',
                    ...
                    <td class="px-5 py-3">
                        <span class="inline-flex px-2 py-0.5 rounded text-xs font-medium
                            {{ $order->network_membership === 'NETWORK' ? 'bg-green-900/30 text-green-400 border border-gray-700' : 'bg-gray-700 text-gray-400' }}">
