    ...
    <form method="POST" action="/super/settings" class="space-y-6">
        ...
        <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
            <div class="px-5 py-4 border-b border-gray-100 bg-gray-50">
                <h3 class="text-sm font-semibold text-gray-700">Currency</h3>
            </div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
            <div class="px-5 py-4 border-b border-gray-100 bg-gray-50">
                <h3 class="text-sm font-semibold text-gray-700">Regional</h3>
            </div>
            <div class="p-5 grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    <label class="block text-xs font-medium text-gray-700 mb-1">Display Timezone</label>
    ...
    <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
        ...
        <dl class="grid grid-cols-1 sm:grid-cols-3 divide-y sm:divide-y-0 sm:divide-x divide-gray-100">
            <div class="px-5 py-4">
                ...
                <dd class="mt-1 text-sm font-medium text-gray-800">{{ config('services.ppb.mode', env('PPB_MODE', 'FILE')) }}</dd>
            </div>
            <div class="px-5 py-4">
                <dt class="text-xs text-gray-400">Environment</dt>
                <dd class="mt-1 text-sm font-medium text-gray-800">{{ app()->environment() }}</dd>
            </div>
            <div class="px-5 py-4">
                <dt class="text-xs text-gray-400">Laravel Version</dt>
                <dd class="mt-1 text-sm font-medium text-gray-800">{{ app()->version() }}</dd>
            </div>
        </dl>
    </div>
